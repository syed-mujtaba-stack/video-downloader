    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-white text-neutral-900 overflow-hidden select-none animate-in fade-in duration-200">
      ...
      <div className="border-b border-neutral-200 bg-neutral-50 px-4 py-2.5 flex flex-col gap-2 shrink-0">
        <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
          <div className="flex items-center gap-1.5 text-xs font-bold text-black shrink-0 px-2.5 py-1 bg-white border border-neutral-200 rounded-lg shadow-2xs">
          ...
          <div className="relative flex-1 min-w-[200px]">
            ...
            <button
              ...
              className="absolute right-1.5 top-1/2 -translate-y-1/2 px-2.5 py-1 rounded-lg bg-black hover:bg-neutral-800 text-white text-[11px] font-semibold flex items-center gap-1 transition-all disabled:opacity-40"
            >
              {isAiThinking ? (
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto py-0.5 shrink-0">
            {[
              { icon: Zap, label: "30s Viral Reel", prompt: "Make a 30s viral TikTok reel with bold hook" },
              { icon: Film, label: "Cinematic Widescreen", prompt: "Format to 16:9 widescreen with cinematic color grade" },
              { icon: Gauge, label: "1.5x Speed Recap", prompt: "Fast 1.5x recap square format" },
              { icon: Smartphone, label: "WhatsApp Clip", prompt: "First 30 seconds clip for WhatsApp status" },
            ].map((chip) => {
              ...
              return (
                <button
                  ...
                  className="px-2.5 py-1 rounded-lg bg-white border border-neutral-200 hover:border-black hover:bg-neutral-100 text-[10px] font-semibold text-neutral-800 whitespace-nowrap transition-all shadow-2xs flex items-center gap-1.5"
                >
